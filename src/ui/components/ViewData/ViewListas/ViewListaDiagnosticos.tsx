...
import { CreateDiagnosticoModal } from "../../FormsModal/Diagnosticos/CreateDiagnosticoModal";
  ...
  return (
    <>
      <CreateDiagnosticoModal
        ...
        onConfirm={
          //@ts-ignore
          window.diagnostico.createDiagnostico
        }
          ...
          <div className="flex flex-col shadow-md">
            {filteredData.map((item) => (
              <HCardView
                ...
                funcion={
                  //@ts-ignore
                  window.diagnostico.deleteDiagnostico
                }
                refresh={() => setRefresh(true)}
                prescription=""
                key={item.id}
